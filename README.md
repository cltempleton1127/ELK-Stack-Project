...
To check if the ELK-SERVER is running, the first instance of the Kibana URL in my project is "http[]()://13.83.51.111/app/kibana": [Filebeats Success image](https://github.com/cltempleton1127/ELK-Stack-Project/blob/main/Additional%20Resources/Filebeat_check_data_kibana_success.png) 
